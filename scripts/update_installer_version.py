...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Cosmophone Demo Installer\n"
      else:
        line="OutputBaseFilename=Cosmophone Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Cosmophone Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Cosmophone installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Cosmophone Demo installer\n"
     else:
       line="SetupWindowTitle=Cosmophone installer\n"
